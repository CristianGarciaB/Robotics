 ...
 *
 * Just: "${PATH_TO_BINARY}/Bug --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class Bug : public RoboComp::Application
{
public:
	Bug (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
int ::Bug::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
