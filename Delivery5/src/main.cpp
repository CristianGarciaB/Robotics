 ...
 *
 * Just: "${PATH_TO_BINARY}/map --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class map : public RoboComp::Application
{
public:
	map (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
int ::map::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
