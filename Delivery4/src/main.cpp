 ...
 *
 * Just: "${PATH_TO_BINARY}/bug2 --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class bug2 : public RoboComp::Application
{
public:
	bug2 (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
int ::bug2::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
